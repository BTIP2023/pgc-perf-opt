...
# pca_3d <- function(pca_df) {
#   components <- data.frame(pca_df[["x"]])
#   # components$PC2 <- -components$PC2
#   # components$PC3 <- -components$PC3
#   # 
#   # components = cbind(components, data$variant)
# 
# 
#   # Save plot as PNG and HTML
#   save_plot("3d-pca", k, components, is3D=TRUE)
# }
...
# Generate 3D PCA plot (unfunctional)
# pca_3d(pca_df)
