...
<iframe src="presentation_files/img/pca-3.html" width=700px height=500px></iframe>
...
<iframe src="presentation_files/img/pca-5.html" width=700px height=500px></iframe>

## PCA plots were generated from the k-mer (k=5) analysis results {data-background="presentation_files/img/PGCSlideLight.svg" transition="fade-in slide-out" transition-speed="slow"}
<iframe src="presentation_files/img/pca-7.html" width=700px height=500px></iframe>
...
<iframe src="presentation_files/img/pca-combined.html" width=700px height=500px></iframe>
