...
::: {layout-ncol=2}
![](presentation_files/img/pandemic-4.webp)

![](presentation_files/img/pandemic-2.jpg)
:::
...
## Unsupervised machine learning can aid in identifying and understanding SARS-CoV-2 variants
...
### t-SNE and UMAP performs Nonlinear Dimensionality Reduction
::: {layout-ncol=2 layout-valign="center"}
![t-SNE follows per-point nonlinear distance comparisons](presentation_files/img/tsne-animated.gif)

![UMAP projects data from a manifold](presentation_files/img/umap-animated.gif)
:::

t-SNE and UMAP uses statistical and topological techniques to map data points to lower dimensions, respectively.

### AGNES performs hiearchical clustering
...
### With these cutting-edge UML strategies, new insights may be gained that will boost our collective fight against infectious diseases.

## Rationale 1: Chandra et al.'s approach is ripe for optimization {data-background="presentation_files/img/PGCSlideLight.svg" transition="fade-in slide-out" transition-speed="slow"}
