...
## Data Preprocessing: FASTA and Metadata files were extracted and cleaned from .tar files obtained from the GISAID database. {data-background="presentation_files/img/PGCSlideLight.svg" transition="fade-in slide-out" transition-speed="slow"}
...
## Data Preprocessing: Sequences and metadata of cleaned and sampled data were saved for possible use in further downstream analysis {data-background="presentation_files/img/PGCSlideLight.svg" transition="fade-in slide-out" transition-speed="slow"}
...
```{r out.width="1800px", out.height="900px", fig.cap="7-mer heatmap"}
