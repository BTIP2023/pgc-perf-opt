...
![Sample benchmarking of linear algebra libraries.](presentation_files/img/linalg-comparisons.png){fig-align="left" width=150% height=150%}
...
::: {layout="[[50],[25]]"}
![](presentation_files/img/meltre.png){fig-align="center" height=60% width=40%}

![](presentation_files/img/cpus-1.jpg){fig-align="center" height=60% width=40%}
...
![](presentation_files/img/pipeline-flowchart-2.png){.fragment fig-align="center" height=60% width=60%}
