...
## *Rationale 1:* Treating Philippine Data with an enhanced UML workflow may uncover new insights about COVID-19 in the country. {data-background="presentation_files/img/PGCSlideLight.svg" transition="fade-in slide-out" transition-speed="slow" .scrollable}
...
## Among many other reasons, an in-house, inspired yet highly original UML variant classifier workflow is in order.
...
We conduct our pilot benchmarks on the UML workflow that we developed. 

## {auto-animate=true auto-animate-easing="ease-in-out"}
**BLAS/LAPACK libraries work closely with the hardware layer.**

![](presentation_files/img/linalg-libs.png){fig-align="center"}

This may yield significant performance boost.

## {auto-animate=true auto-animate-easing="ease-in-out"}
***Rationale 2:* Optimized linear algebra libraries may offer improved bioinformatics performance** 

::: {layout-ncol=2}
![](presentation_files/img/linalg-libs.png){fig-align="center"}

![](presentation_files/img/linalg-comparisons.png){fig-align="center"}
...
::: {layout-ncol=2}
![](presentation_files/img/meltre.png){}

![](presentation_files/img/cpus-1.jpg){}
