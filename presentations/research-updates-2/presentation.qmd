...
![](presentation_files/img/stratified_sampler.png){.fragment fig-align="center" height=900px width=900px}

## Region metadata entries were cleaned of duplicate regions{data-="presentation_files/img/PGCSlideLight.svg" transition="fade-in slide-out" transition-speed="slow"}

![](presentation_files/img/region_cleanup.png){.fragment fig-align="center" height=70% width=70%}
...
:::: {.column width="50%"}
![](presentation_files/img/python.png){.fragment fig-align="center" height=60% width=60%}
::::

:::: {.column width="50%"}
![](presentation_files/img/r-port.png){.fragment fig-align="center" height=60% width=60%}
::::
